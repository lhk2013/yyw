        ...
        bootstrap.group(bossGroup, workerGroup)
                ...
                .childHandler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        com.yyw.fangkuaiyi.dubbo.remoting.netty4.NettyCodecAdapter adapter = new com.yyw.fangkuaiyi.dubbo.remoting.netty4.NettyCodecAdapter(getCodec(), getUrl(), NettyServer.this);
                        ...
                        pipeline.addLast("writeHandler",new ChannelOutboundHandlerAdapter(){
                            ...
                            public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
                                ...
                                com.yyw.fangkuaiyi.dubbo.remoting.netty4.NettyChannel channel = com.yyw.fangkuaiyi.dubbo.remoting.netty4.NettyChannel.getOrAddChannel(ctx.channel(), getUrl(), NettyServer.this);
                                try {
